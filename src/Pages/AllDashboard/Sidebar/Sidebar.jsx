            ...
            >
                        ...
                        <nav>
                            <>
                                ...
                                >
                                    ...
                                    />
                                    <span className='px-4 py-1 rounded-l-md text-white bg-[#fc541a] peer-checked:bg-gray-800'>
                                        Student
                                    </span>
                                    <span className='px-4 py-1 rounded-r- text-white bg-gray-800 peer-checked:bg-[#fc541a]'>
                                        Instructor
                                    </span>
                                </label>
                                {/* Menu Links */}
                ...
                <div>
                    ...
                    <button
                        ...
                        className='flex w-full items-center px-4 py-2 mt-2 text-white  hover:bg-gray-300   hover:text-gray-700 transition-colors duration-300 transform'
                    >
