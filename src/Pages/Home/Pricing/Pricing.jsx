                        ...
                        {pricingPlans.map((plan, index) => (
                            ...
                            >
                                ...
                                <div className="px-6 py-4 bg-gray-50">
                                    <button className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#fc541a] hover:bg-[#193038]">
                                        Select
                                    </button>
                                </div>
                            </div>
